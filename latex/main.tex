...
\BITSetup{
  ...
  info = {
    ...
    titleEn = {Research on Adversarial Malware Generation Methods Based on Reinforcement Learning},
    school = 计算机学院,
    major = 计算机科学与技术,
    class = 07112105,
    author = 李函书,
...
\input{chapters/2_prerequisites}
\input{chapters/3_System_module_design}
\input{chapters/4_experimental_design_and_results_analysis}
