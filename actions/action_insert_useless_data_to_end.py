...
def action_insert_useless_data_to_end(input_file_):
    ...
    append_to_pe(input_file=input_file_,append_data=get_random_string(string_list=strings_4096bytes))
...
if __name__ == "__main__":
    ...
    action_insert_useless_data_to_end(input_file_=input_file)